<template>
  <a
    :href="item.path"
    class="flex gap-1 items-center text-lg sm:text-xl md:text-2xl text-lime-500 cursor-pointer transition-transform duration-300 hover:-translate-y-2 relative group"
  >
    <span
